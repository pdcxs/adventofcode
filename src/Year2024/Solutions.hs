...
solutions =
  M.fromList
    ...
    , ((2024, 18, 1), Year2024.Day18.solution1)
    , ((2024, 18, 2), Year2024.Day18.solution2)
    , ((2024, 19, 1), Year2024.Day19.solution1)
    , ((2024, 19, 2), Year2024.Day19.solution2)
    , ((2024, 20, 1), Year2024.Day20.solution1)
    , ((2024, 20, 2), Year2024.Day20.solution2)
    , ((2024, 21, 1), Year2024.Day21.solution1)
    , ((2024, 21, 2), Year2024.Day21.solution2)
    , ((2024, 22, 1), Year2024.Day22.solution1)
    , ((2024, 22, 2), Year2024.Day22.solution2)
    , ((2024, 23, 1), Year2024.Day23.solution1)
    , ((2024, 23, 2), Year2024.Day23.solution2)
    , ((2024, 24, 1), Year2024.Day24.solution1)
    , ((2024, 24, 2), Year2024.Day24.solution2)
    , ((2024, 25, 1), Year2024.Day25.solution1)
    , ((2024, 25, 2), Year2024.Day25.solution2)
    ]
